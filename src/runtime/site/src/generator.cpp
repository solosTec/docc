...
namespace docscript {
    ...
    generator::generator(
        ...
        , vars_()
        , meta_(cyng::param_map_factory("build", std::chrono::system_clock::now())("title", cfg_page.title_)("locale", locale)(
              "country",
              country)("language", language)("encoding", encoding))
        , toc_()
        //, footnotes_()
        //, figures_()
        //, tables_()
    ...
    void generator::emit_navbar(std::ostream &os, navbar const &nb, page const &p) {
        ...
        os << "\t\t<a class=\"navbar-brand\" href=\"#\">" << p.title_ << "</a>\n";
        os << "\t</nav>\n";
        os << "</div>\n";
    }
